...
var _getBucketName = function(ctx) {
    return Config.getValue(ctx.tenant().alias, 'amazons3storage', 'bucket');
};
...
var _getClient = function(ctx) {
    ...
    var accessKey = Config.getValue(ctx.tenant().alias, 'amazons3storage', 'access-key');
    var secretKey = Config.getValue(ctx.tenant().alias, 'amazons3storage', 'secret-key');
    var region = Config.getValue(ctx.tenant().alias, 'amazons3storage', 'region');
